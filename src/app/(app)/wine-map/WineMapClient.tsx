  ...
  return (
    <div className="flex flex-col h-[calc(100dvh-80px)] bg-background">
      ...
      <div className="flex-1 relative">
        ...
        {/* 플로팅 버튼들 */}
        <div className={`absolute right-4 z-[999] flex flex-col gap-2 transition-all ${selectedGroup ? (selectedGroup.length > 1 ? "bottom-44" : "bottom-36") : "bottom-4"}`}>
          <button
        ...
        <div className={`absolute left-1/2 -translate-x-1/2 z-[999] transition-all ${selectedGroup ? (selectedGroup.length > 1 ? "bottom-44" : "bottom-36") : "bottom-4"}`}>
          <button
