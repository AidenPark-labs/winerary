...
export default function DiaryListItem({ diary }: { diary: MockDiary }) {
  return (
    <button
      type="button"
      className="w-full flex items-center gap-3 p-3 rounded-[12px] text-left bg-[var(--surface-raised)] border border-[var(--border)] hover:bg-[var(--surface-alt)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]"
    >
