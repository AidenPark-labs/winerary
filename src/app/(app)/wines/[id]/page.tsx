    ...
    <div className="relative min-h-screen bg-black">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="relative overflow-visible">
          ...
          <div className="absolute inset-x-0 bottom-0 pointer-events-none" style={{ height: "40%", background: "linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.15) 30%, rgba(0,0,0,0.4) 55%, rgba(0,0,0,0.7) 75%, rgba(0,0,0,0.9) 90%, rgba(0,0,0,1) 100%)" }} />
